...
```
    ...
    <__main__.EgClass object at 0x0000029BFF5F0780>
...
```
    ...
    <ipython-input-86-8c607f2aa25b> in <module>()
    ----> 1 a.name = 1
...
```
    ...
    <ipython-input-89-001bfa8fe26b> in <module>()
    ----> 1 a.age = 0.5
    

    <ipython-input-87-83364d5faa13> in age(self, value)
...
```
    ...
    <__main__.Vector at 0x29bff68b438>
...
```
    ...
    ['e:\\python\\lib\\site-packages\\ipykernel_launcher.py',
     '-f',
     'C:\\Users\\wklchris\\AppData\\Roaming\\jupyter\\runtime\\kernel-28a459b5-85f0-4a99-bca5-298b372d0693.json']
